...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { description: @badge.description, image_url: @badge.image_url, name: @badge.name, summary: @badge.summary }
    end
  ...
  test "should update badge" do
    put :update, id: @badge, badge: { description: @badge.description, image_url: @badge.image_url, name: @badge.name, summary: @badge.summary }
    assert_redirected_to badge_path(assigns(:badge))
  end
