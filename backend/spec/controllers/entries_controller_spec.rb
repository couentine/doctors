  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved entry as @entry" do
        ...
        post :create, {:entry => { "entry_number" => "invalid value" }}, valid_session
        assigns(:entry).should be_a_new(Entry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested entry" do
        ...
        Entry.any_instance.should_receive(:update_attributes).with({ "entry_number" => "1" })
        put :update, {:id => entry.to_param, :entry => { "entry_number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the entry as @entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Entry.any_instance.stub(:save).and_return(false)
        put :update, {:id => entry.to_param, :entry => { "entry_number" => "invalid value" }}, valid_session
        assigns(:entry).should eq(entry)
      end
