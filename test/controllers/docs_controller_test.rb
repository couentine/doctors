...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { name: @doc.name, review: @doc.review, specialty: @doc.specialty, zip: @doc.zip } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { name: @doc.name, review: @doc.review, specialty: @doc.specialty, zip: @doc.zip } }
